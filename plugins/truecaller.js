...
if (Config.WORKTYPE == 'private') {
  ...
  Asena.addCommand({pattern: 'true ?(.*)', desc: 'gives you the detail of your IP' ,fromMe: true}, async (message, match) => {
  ...
  Asena.addCommand({pattern: 'true ?(.*)', desc: 'gives you the detail of your IP' ,fromMe: false}, async (message, match) => {
