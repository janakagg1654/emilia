...
module.exports = {
  ...
  SESSION_ID: (process.env.SESSION_ID || '22_5_331a_b9ce_ff67').trim(),
  DATABASE:
  ...
  HANDLERS: (process.env.PREFIX || 'Boii').trim(),
  SUDO: process.env.SUDO || '2349070329461',
  HEROKU_APP_NAME: process.env.HEROKU_APP_NAME,
  HEROKU_API_KEY: process.env.HEROKU_API_KEY,
  BRANCH: 'master',
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || 'Dah Boii?',
