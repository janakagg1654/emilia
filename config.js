...
module.exports = {
  ...
  SESSION_ID: (process.env.SESSION_ID || '29_6_6170_03be_aa6e').trim(),
  DATABASE:
  ...
  KOYEB_API: (process.env.KOYEB_API || 'v49iwvyh58iikwnparg04f5to69tjfid7f6k9n36mq7hco2b3u2x86e2mlu3nfcn').trim(),
