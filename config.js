...
module.exports = {
  ...
  BRANCH: 'master',
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || '🩵,𝙹𝚎𝚊𝚗 𝙿𝚊𝚛𝚔𝚎𝚛',
  ALWAYS_ONLINE: toBool(process.env.ALWAYS_ONLINE),
  LOG_MSG: toBool(process.env.LOG_MSG) || false,
  RMBG_KEY: process.env.RMBG_KEY || 'K8AjMdNxVoaTMKBEhEkDx7nC',
  ...
  MENTION: process.env.MENTION || 'Oui oui laissez moi dormir juste un peu 🍭',
